          ...
          <div className="bg-gray-800/80 backdrop-blur-xl rounded-2xl p-8 md:p-12 shadow-2xl relative overflow-hidden border border-gray-700">
            ...
            <div className="relative">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-violet-600 to-indigo-600 text-white py-4 rounded-lg font-semibold hover:shadow-[0_0_30px_rgba(124,58,237,0.5)] transition-all duration-300 relative group overflow-hidden mt-12"
                >
